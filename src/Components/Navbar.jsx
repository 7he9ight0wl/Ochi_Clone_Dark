...
const Navbar = () => {
  return (
    <div
      className="fixed z-[999] w-full px-[4.5vw] py-5 font-['Neue Montreal'] flex justify-between items-center backdrop-blur bg-zinc-900"
    >
        ...
        {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
          (item, index) => (
            <motion.a
              ...
              onHoverEnd={(e) => {}}
              key={index}
              className={`text-[1.2vw] capitalize cursor-pointer font-normal text-white ${
                index === 4 && "ml-32"
              }`}
            >
              {item}
