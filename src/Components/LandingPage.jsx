...
function LandingPage() {
  return (
    <div
      ...
      className="w-full h-screen bg-zinc-800 pt-1"
    >
      <div className="textHead mt-40 px-[4.5vw] text-white">
              ...
              <div className="w-fit flex items-end overflow-hidden ">
                {index === 1 && (
                  <motion.div
                    ...
                    className="mr-[0.5vw] w-[8vw] h-[5.2vw] relative -top-[-0vw] bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg')] rounded-md"
                  ></motion.div>
                )}
      ...
      <div className="border-t-[1px] border-zinc-800 mt-32 flex justify-between items-center py-5 px-[4.5vw] text-white">
        {[
